    ...
    <>
      ...
      >
        <header className="w-[100%]">
          <Column className="bg-white_A700 flex flex-col items-center justify-start md:p-[12px] sm:p-[15px] p-[24px] w-[100%]">
            <Column className="flex flex-col items-center justify-start max-w-[1632px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center w-[100%]">
                ...
                <Row className="bg-white_A700 border-2 border-gray_50 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mb-[1px] md:mb-[2px] mb-[5px] md:ml-[212px] ml-[411px] sm:mx-[0] sm:pl-[15px] md:pl-[16px] pl-[32px] sm:w-[100%] w-[36%]">
                  <Text
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap sm:mt-[10px] md:mt-[13px] mt-[27px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[48%] common-row-list">
        ...
        <Column className="flex flex-col items-center justify-start w-[100%]">
          <div className="overflow-auto overflow-x-auto w-[100%]">
            <Stack className="h-[750px] max-w-[2054px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] relative w-[100%]">
                  ...
                  items={[...Array(12)].map(() => (
                    <React.Fragment key={Math.random()}>
                      <Column
                        ...
                        style={{
                          backgroundImage: "url('images/img_group1709.png')",
                        }}
                      >
                        <Column className="bg-black_900_68 flex flex-col justify-end sm:p-[15px] md:p-[16px] p-[32px] w-[100%]">
                          <Column className="flex flex-col justify-start ml-[112px] md:ml-[57px] sm:mt-[34px] md:mt-[44px] mt-[86px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[44%]">
              ...
              <Row className="absolute bottom-[4%] flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mx-[0] sm:pl-[0] sm:pr-[15px] pr-[176px] md:pr-[90px] right-[0] shadow-bs sm:w-[100%] w-[60%]">
                <Column className="bg-white_A700 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center sm:p-[15px] md:px-[17px] px-[34px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-start mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                    <Img
                ...
                <Column className="bg-white_A700 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center ml-[16px] sm:ml-[6px] md:ml-[8px] sm:p-[15px] md:px-[15px] px-[30px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-end mt-[1px] sm:mx-[0] p-[4px] sm:px-[0] sm:w-[100%] w-[57%]">
                    <Img
                ...
                <Column className="bg-white_A700 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center ml-[16px] sm:ml-[6px] md:ml-[8px] sm:p-[15px] md:px-[15px] px-[30px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-start mt-[1px] sm:mx-[0] p-[2px] sm:px-[0] sm:w-[100%] w-[57%]">
                    <Img
                ...
                <Column className="bg-gray_800 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center ml-[16px] sm:ml-[6px] md:ml-[8px] sm:p-[15px] md:px-[15px] px-[30px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-start mt-[1px] sm:mx-[0] p-[1px] sm:px-[0] sm:w-[100%] w-[57%]">
                    <Img
                ...
                <Column className="bg-white_A700 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center ml-[16px] sm:ml-[6px] md:ml-[8px] sm:p-[15px] md:px-[15px] px-[30px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-start mt-[1px] sm:mx-[0] p-[3px] sm:px-[0] sm:w-[100%] w-[57%]">
                    <Img
                ...
                <Column className="bg-white_A700 flex flex-col h-[160px] sm:h-[64px] md:h-[83px] items-center ml-[16px] sm:ml-[6px] md:ml-[8px] sm:p-[15px] md:px-[16px] px-[31px] w-[160px] sm:w-[63px] md:w-[82px]">
                  <Column className="flex flex-col items-center justify-start mb-[3px] mt-[11px] sm:mt-[4px] md:mt-[5px] sm:px-[0] w-[100%]">
                    <Img
          ...
          <Img
            ...
            alt="Vector Three"
          />
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1633px] ml-[auto] mr-[auto] mt-[115px] sm:mt-[45px] md:mt-[59px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
          ...
          <Column className="flex flex-col items-center justify-start max-w-[1632px] ml-[auto] mr-[auto] mt-[100px] sm:mt-[39px] md:mt-[51px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:pt-[3px] md:pt-[4px] pt-[8px] sm:px-[0] w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:px-[0] sm:w-[100%] w-[7%]">
                <Text
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[15px] md:mt-[20px] mt-[40px] w-[100%]">
              <Column className="flex flex-col items-center sm:mx-[0] sm:pb-[2px] md:pb-[3px] pb-[7px] sm:px-[0] sm:w-[100%] w-[33%]">
                <Column
              ...
              <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                <Grid className="sm:gap-[12px] md:gap-[16px] gap-[32px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-4 min-h-[auto] w-[100%]">
                  ...
                  <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[46%]">
                      <Text
                        className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                        as="h6"
                        variant="h6"
                  ...
                  <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col items-center justify-start md:mt-[11px] mt-[23px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[60%]">
                      <Text
                  ...
                  <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[21px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[58%]">
                      <Text
                        className="font-medium text-gray_800 w-[auto]"
                        as="h6"
                        variant="h6"
          ...
          <Stack className="h-[579px] mt-[100px] sm:mt-[39px] md:mt-[51px] relative w-[100%]">
            <Column className="absolute bg-gray_800 flex flex-col justify-start sm:p-[15px] md:p-[26px] p-[52px] top-[0] w-[100%]">
              <Column className="flex flex-col items-center justify-start sm:mb-[108px] md:mb-[139px] mb-[271px] md:ml-[46px] ml-[91px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[14%]">
                <Text
            ...
            >
              <Row className="bg-gray_50 flex flex-row md:flex-wrap sm:flex-wrap items-center sm:p-[15px] md:p-[16px] p-[32px] shadow-bs1 w-[100%]">
                ...
                <Column className="flex flex-col items-center md:ml-[24px] ml-[48px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[53%]">
                  <Column className="flex flex-col justify-start w-[100%]">
                    <Text
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[12px] md:mt-[16px] mt-[31px] w-[100%]">
                      <Column className="border border-gray_500 border-solid flex flex-col h-[107px] sm:h-[43px] md:h-[56px] items-center md:px-[11px] sm:px-[15px] px-[22px] w-[107px] sm:w-[42px] md:w-[55px]">
                        <Column className="flex flex-col items-center justify-start mt-[1px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[83%]">
                          <Text
                            className="font-medium text-gray_800 w-[auto]"
                            as="h6"
                            variant="h6"
                      ...
                      <Column className="border border-gray_500 border-solid flex flex-col h-[107px] sm:h-[43px] md:h-[56px] items-center sm:px-[15px] px-[18px] md:px-[9px] w-[107px] sm:w-[42px] md:w-[55px]">
                        <Column className="flex flex-col items-center justify-start my-[4px] sm:px-[0] w-[100%]">
                          <Text
                            className="font-medium text-gray_800 w-[auto]"
                            as="h6"
                            variant="h6"
                      ...
                      <Column className="border border-gray_500 border-solid flex flex-col h-[107px] sm:h-[43px] md:h-[56px] items-center px-[14px] sm:px-[5px] md:px-[7px] w-[107px] sm:w-[42px] md:w-[55px]">
                        <Column className="flex flex-col items-center justify-start sm:mx-[0] sm:my-[3px] md:my-[4px] my-[8px] sm:px-[0] sm:w-[100%] w-[99%]">
                          <Text
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[22px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[36%]">
                      <Text
              ...
              <Row className="bg-gray_50 flex flex-row md:flex-wrap sm:flex-wrap items-center sm:p-[15px] md:p-[16px] p-[32px] shadow-bs1 w-[100%]">
                ...
                <Column className="flex flex-col items-center md:ml-[24px] ml-[48px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[53%]">
                  <Column className="flex flex-col justify-start w-[100%]">
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[36%]">
                      <Text
                        className="font-normal line-through mb-[1px] not-italic text-gray_500 w-[auto]"
                        as="h6"
                        variant="h6"
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1634px] ml-[auto] mr-[auto] mt-[100px] sm:mt-[39px] md:mt-[51px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:pt-[2px] md:pt-[3px] pt-[7px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
              ...
              <Column className="flex flex-col items-center justify-start sm:mt-[16px] md:mt-[21px] mt-[42px] w-[100%]">
                <Grid className="sm:gap-[13px] md:gap-[17px] gap-[34px] grid sm:grid-cols-1 grid-cols-2 min-h-[auto] w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end p-[17px] md:p-[8px] sm:px-[15px] sm:py-[6px] w-[100%]">
                    <Img
                      ...
                      alt="placeholder"
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[63%]">
                      <Text
                        className="font-medium text-gray_800 w-[auto]"
                        as="h6"
                        variant="h6"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end md:pl-[12px] sm:pl-[15px] pl-[24px] sm:pr-[0] md:py-[12px] py-[24px] sm:py-[9px] w-[100%]">
                    <Img
                      ...
                      alt="placeholder One"
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                      <Text
                        className="font-medium text-gray_800 w-[auto]"
                        as="h6"
                        variant="h6"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    <Img
                      src="images/img_placeholder_250X250.png"
                      className="h-[107px] sm:h-[43px] md:h-[56px] max-w-[100%] md:my-[11px] my-[22px] sm:my-[8px] w-[107px] sm:w-[42px] md:w-[55px]"
                      alt="placeholder Two"
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[51%]">
                      <Text
                        className="font-medium text-gray_800 w-[auto]"
                        as="h6"
                        variant="h6"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[52%]">
                      <Text
                        className="font-medium text-gray_800 w-[auto]"
                        as="h6"
                        variant="h6"
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[178px] ml-[346px] sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[14%]">
                <Text
                  className="flex-grow font-medium text-gray_800"
                  variant="body1"
                >
            ...
            <Column className="flex flex-col md:ml-[15px] ml-[30px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
              <Text
                className="font-bold text-gray_800 w-[auto]"
                as="h5"
                variant="h5"
              ...
              <Column className="flex flex-col items-center justify-start sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]">
                <Grid className="sm:gap-[13px] md:gap-[17px] gap-[34px] grid sm:grid-cols-1 grid-cols-2 min-h-[auto] w-[100%]">
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    <Img
                    ...
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] md:my-[10px] my-[20px] sm:my-[7px] sm:pt-[1px] md:pt-[2px] pt-[5px] sm:px-[0] sm:w-[100%] w-[40%]">
                      <Column className="flex flex-col justify-start w-[100%]">
                        <Text
                          className="font-medium text-gray_800 w-[auto]"
                          as="h6"
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] md:my-[10px] my-[20px] sm:my-[7px] pt-[4px] sm:px-[0] sm:w-[100%] w-[41%]">
                      <Column className="flex flex-col justify-start w-[100%]">
                        <Text
                          className="font-medium text-gray_800 w-[auto]"
                          as="h6"
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[22px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[82%]">
                        <RatingBar
                          className=""
                          value={4}
                          starCount={5}
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    <Img
                      ...
                      alt="placeholder Six"
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] md:my-[10px] my-[20px] sm:my-[7px] sm:pt-[3px] md:pt-[4px] pt-[8px] sm:px-[0] sm:w-[100%] w-[54%]">
                      <Column className="flex flex-col justify-start w-[100%]">
                        <Text
                          className="font-medium text-gray_800 w-[auto]"
                          as="h6"
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[22px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[63%]">
                        <RatingBar
                          className=""
                          value={4}
                          starCount={5}
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] p-[24px] sm:px-[15px] sm:py-[9px] w-[100%]">
                    ...
                    />
                    <Column className="flex flex-col ml-[16px] md:ml-[8px] sm:mx-[0] md:my-[10px] my-[20px] sm:my-[7px] sm:pt-[3px] md:pt-[4px] pt-[8px] sm:px-[0] sm:w-[100%] w-[43%]">
                      <Column className="flex flex-col justify-start w-[100%]">
                        <Text
                          className="font-medium text-gray_800 w-[auto]"
                          as="h6"
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[11px] mt-[22px] sm:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[78%]">
                        <RatingBar
                          className=""
                          value={4}
                          starCount={5}
          ...
          <List
            ...
            orientation="horizontal"
          >
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center max-w-[384px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] md:pr-[33px] pr-[64px] sm:py-[25px] md:py-[33px] py-[64px] w-[100%]">
              <Img
                src="images/img_music.svg"
                className="sm:h-[20px] md:h-[25px] h-[48px] max-w-[100%] sm:w-[19px] md:w-[24px] w-[48px]"
                alt="music"
              />
              <Column className="flex flex-col md:ml-[16px] ml-[32px] md:mr-[14px] mr-[29px] sm:mt-[1px] md:mt-[2px] mt-[5px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                <Text
                  className="font-bold text-gray_800 w-[auto]"
                  variant="body1"
                >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center max-w-[384px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] md:pr-[33px] pr-[64px] sm:py-[25px] md:py-[33px] py-[64px] w-[100%]">
              <Img
                ...
                alt="computer"
              />
              <Column className="flex flex-col md:ml-[16px] ml-[32px] md:mr-[14px] mr-[29px] sm:mt-[2px] md:mt-[3px] mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                <Text
                  className="font-bold text-gray_800 w-[auto]"
                  variant="body1"
                >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center max-w-[384px] ml-[auto] mr-[auto] sm:pl-[15px] sm:pr-[15px] md:pr-[33px] pr-[64px] sm:py-[25px] md:py-[33px] py-[64px] w-[100%]">
              <Img
                ...
                alt="clock"
              />
              <Column className="flex flex-col md:ml-[16px] ml-[32px] md:mr-[14px] mr-[29px] sm:mt-[2px] md:mt-[3px] mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[66%]">
                <Text
                  className="font-bold text-gray_800 w-[auto]"
                  variant="body1"
                >
