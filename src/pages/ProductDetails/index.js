    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-poppins items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col items-center justify-start sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1632px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
              <Img
                ...
                alt="placeholder"
              />
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mt-[12px] md:mt-[16px] mt-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[61%]">
                <Img
            ...
            <Column className="flex flex-col md:ml-[16px] ml-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
              <Column className="flex flex-col justify-start pt-[4px] w-[100%]">
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[39%]">
                  <Text
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[35%]">
                <Text
                ...
                <Stack className="h-[48px] md:ml-[12px] ml-[24px] sm:ml-[9px] relative sm:w-[100%] w-[63%]">
                  ...
                  <Column className="absolute bg-gray_50 flex flex-col sm:h-[20px] md:h-[25px] h-[48px] items-center justify-start left-[0] sm:p-[15px] px-[19px] md:px-[9px] sm:w-[19px] md:w-[24px] w-[48px]">
          ...
          <Column className="flex flex-col items-center justify-start max-w-[1632px] ml-[auto] mr-[auto] mt-[183px] sm:mt-[73px] md:mt-[94px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between py-[3px] w-[100%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[25%]">
                <Text
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]">
              ...
              >
                <Column className="flex flex-col items-center justify-center md:p-[34px] p-[67px] sm:px-[15px] sm:py-[26px] w-[100%]">
                  ...
                  />
                  <Column className="flex flex-col items-center justify-start sm:mx-[0] my-[19px] sm:my-[7px] md:my-[9px] sm:px-[0] sm:w-[100%] w-[74%]">
                    <Text
                      className="font-medium text-gray_800 w-[auto]"
                      as="h6"
                      variant="h6"
