    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-poppins items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col justify-start sm:mt-[14px] md:mt-[18px] mt-[36px] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[202px] md:ml-[74px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Text
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[1632px] md:ml-[74px] ml-[auto] mr-[auto] sm:mt-[27px] md:mt-[36px] mt-[70px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col justify-start sm:mx-[0] sm:pt-[2px] md:pt-[3px] pt-[6px] sm:px-[0] sm:w-[100%] w-[16%]">
              <Column className="flex flex-col justify-start w-[100%]">
                ...
                <Column className="flex flex-col justify-start sm:mt-[12px] md:mt-[16px] mt-[31px] sm:mx-[0] pb-[1px] sm:px-[0] sm:w-[100%] w-[60%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[61%]">
                    <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                    <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[71%]">
                    <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[24px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[59%]">
                    <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center md:mt-[12px] mt-[25px] sm:mt-[9px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[94%]">
                    <Img
              ...
              <Line className="bg-bluegray_100 h-[1px] sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]" />
              <Column className="flex flex-col justify-start sm:mt-[14px] md:mt-[19px] mt-[37px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[68%]">
                <Text
                  className="font-medium text-gray_800 w-[auto]"
                  variant="body1"
                >
                ...
                <Column className="flex flex-col justify-end sm:mt-[12px] md:mt-[16px] mt-[32px] py-[1px] w-[100%]">
                  <CheckBox
                    ...
                    label="All Price"
                  ></CheckBox>
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mr-[auto] sm:mt-[10px] md:mt-[13px] mt-[27px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[87%]">
                    <Button
              ...
              <Line className="bg-bluegray_100 h-[1px] sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]" />
              <Column className="flex flex-col justify-start sm:mt-[14px] md:mt-[19px] mt-[37px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[79%]">
                <Text
                  className="font-medium text-gray_800 w-[auto]"
                  variant="body1"
                >
                ...
                <Column className="flex flex-col justify-start sm:mt-[12px] md:mt-[16px] mt-[32px] w-[100%]">
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[50%]">
                    <div className="border-bluegray_100 border-bw3 border-solid sm:h-[10px] md:h-[13px] h-[24px] md:w-[12px] w-[24px] sm:w-[9px]"></div>
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[59%]">
                      <Img
                  ...
                  <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[67%]">
                    <div className="border-bluegray_100 border-bw3 border-solid sm:h-[10px] md:h-[13px] h-[24px] md:w-[12px] w-[24px] sm:w-[9px]"></div>
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[69%]">
                      <Img
                  ...
                  >
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center sm:mx-[0] sm:px-[0] sm:w-[100%] w-[84%]">
                      <Button
                        className="flex sm:h-[10px] md:h-[13px] h-[24px] items-center justify-center md:w-[12px] w-[24px] sm:w-[9px]"
                        size="smIcn"
                        variant="icbFillGray800"
                      ...
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between ml-[16px] md:ml-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[75%]">
                        <Img
                    ...
                    <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between w-[100%]">
                      <div className="border-bluegray_100 border-bw3 border-solid sm:h-[10px] md:h-[13px] h-[24px] md:w-[12px] w-[24px] sm:w-[9px]"></div>
                      <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-evenly sm:mx-[0] sm:px-[0] sm:w-[100%] w-[80%]">
                        <RatingBar
                          className=""
                          value={5}
                          starCount={5}
            ...
            <Column className="flex flex-col items-center justify-start md:ml-[16px] ml-[32px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[84%]">
              ...
              >
                <Column className="flex flex-col items-center justify-start w-[100%]">
                  <Grid className="sm:gap-[12px] md:gap-[16px] gap-[32px] grid sm:grid-cols-1 md:grid-cols-2 grid-cols-5 min-h-[auto] w-[100%]">
                    ...
                    <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[56%]">
                        <Text
                          className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                          as="h6"
                          variant="h6"
                    ...
                    <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start md:mt-[10px] mt-[20px] sm:mt-[7px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[56%]">
                        <Text
                          className="font-medium text-gray_800 w-[auto]"
                          as="h6"
                          variant="h6"
                    ...
                    <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[77%]">
                        <Text
                          className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                          as="h6"
                          variant="h6"
                    ...
                    <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[71%]">
                        <Text
                          className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                          as="h6"
                          variant="h6"
                    ...
                    <Column className="flex flex-col justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start md:ml-[25px] ml-[50px] mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[65%]">
                        <Text
                          className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                          as="h6"
                          variant="h6"
                    ...
                    <Column className="flex flex-col items-center justify-start pb-[4px] sm:px-[0] w-[100%]">
                      ...
                      />
                      <Column className="flex flex-col items-center justify-start mt-[16px] sm:mt-[6px] md:mt-[8px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[53%]">
                        <Text
                          className="font-medium leading-[normal] text-center text-gray_800 w-[100%]"
                          as="h6"
                          variant="h6"
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center sm:mt-[22px] md:mt-[28px] mt-[56px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[22%]">
                  <Img
