    ...
    <>
      <Column className="bg-white_A700 flex flex-col font-poppins items-center justify-start mx-[auto] w-[100%]">
        ...
        <Column className="flex flex-col justify-start sm:mt-[13px] md:mt-[18px] mt-[35px] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start max-w-[229px] md:ml-[74px] ml-[auto] mr-[auto] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Text
          ...
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center max-w-[1604px] md:ml-[74px] ml-[auto] mr-[auto] mt-[100px] sm:mt-[39px] md:mt-[51px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[29px] ml-[57px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[40%]">
          ...
          <Column className="flex flex-col items-end justify-start max-w-[1632px] md:ml-[74px] ml-[auto] mr-[auto] sm:mt-[31px] md:mt-[41px] mt-[80px] sm:mx-[0] sm:pl-[15px] sm:pr-[15px] sm:px-[0] w-[100%]">
            <Column className="flex flex-col items-center justify-start w-[100%]">
              ...
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-between sm:mt-[12px] md:mt-[16px] mt-[32px] sm:pb-[3px] md:pb-[4px] pb-[8px] w-[100%]">
                <Row className="border border-bluegray_100 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mx-[0] sm:pl-[15px] pl-[16px] md:pl-[8px] sm:pr-[0] sm:w-[100%] w-[29%]">
                  <Text
                ...
                <Column className="flex flex-col items-end justify-start mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[9%]">
                  <Text
                    className="font-medium text-gray_500 w-[auto]"
                    variant="body1"
                  >
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end ml-[auto] sm:mt-[31px] md:mt-[41px] mt-[80px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[26%]">
              <Button
