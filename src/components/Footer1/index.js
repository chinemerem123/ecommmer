      ...
      <footer className={props.className}>
        <Column className="flex flex-col items-center justify-start sm:mb-[12px] md:mb-[16px] mb-[32px] sm:mt-[25px] md:mt-[33px] mt-[64px] mx-[auto] sm:w-[100%] w-[85%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly w-[100%]">
            ...
            <Column className="flex flex-col justify-start sm:mb-[22px] md:mb-[28px] mb-[56px] sm:mx-[0] pr-[4px] sm:px-[0] py-[4px] sm:w-[100%] w-[17%]">
            ...
            <Column className="flex flex-col justify-end sm:mx-[0] pr-[4px] sm:px-[0] py-[4px] sm:w-[100%] w-[17%]">
            ...
            <Column className="flex flex-col justify-start sm:mb-[28px] md:mb-[36px] mb-[71px] mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[24%]">
              <Text className="font-bold font-poppins sm:text-[20px] md:text-[22px] text-[24px] text-white_A700 w-[auto]">
                Join our Newsletter
              </Text>
