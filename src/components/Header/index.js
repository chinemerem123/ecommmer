  ...
  return (
    <>
      <header className={props.className}>
        <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center md:p-[12px] sm:p-[15px] p-[24px] w-[100%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-center sm:mb-[3px] md:mb-[4px] mb-[9px] ml-[120px] md:ml-[61px] mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[6%]">
            <Img
          ...
          <Row className="bg-white_A700 border-2 border-gray_50 border-solid flex flex-row md:flex-wrap sm:flex-wrap items-center justify-center md:ml-[212px] ml-[411px] sm:mx-[0] sm:pl-[15px] md:pl-[16px] pl-[32px] sm:w-[100%] w-[32%]">
