  ...
  return (
    <>
      <footer className={props.className}>
        <Column className="flex flex-col items-center justify-start sm:mb-[12px] md:mb-[16px] mb-[32px] sm:mt-[25px] md:mt-[33px] mt-[64px] mx-[auto] sm:w-[100%] w-[85%]">
          <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly w-[100%]">
            <Column className="flex flex-col justify-start sm:mb-[14px] md:mb-[18px] mb-[36px] sm:mx-[0] md:pr-[3px] pr-[6px] sm:pt-[2px] md:pt-[3px] pt-[6px] sm:px-[0] sm:w-[100%] w-[43%]">
              <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start sm:mx-[0] sm:px-[0] sm:w-[100%] w-[17%]">
                <Img
              ...
              <Column className="flex flex-col items-center justify-start sm:mt-[14px] md:mt-[19px] mt-[37px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[61%]">
                ...
                <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start mt-[16px] sm:mt-[6px] md:mt-[8px] pr-[4px] py-[4px] w-[100%]">
                  <Img
            ...
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-evenly sm:mx-[0] sm:px-[0] sm:w-[100%] w-[58%]">
              <Column className="flex flex-col justify-start sm:mb-[22px] md:mb-[28px] mb-[56px] sm:mx-[0] pr-[4px] sm:px-[0] py-[4px] sm:w-[100%] w-[30%]">
                <Text className="font-bold font-poppins sm:text-[20px] md:text-[22px] text-[24px] text-white_A700 w-[auto]">
                  Product Links
                </Text>
                <Column className="flex flex-col justify-start mb-[1px] sm:mt-[17px] md:mt-[23px] mt-[45px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[37%]">
              ...
              <Column className="flex flex-col justify-end sm:mx-[0] pr-[4px] sm:px-[0] py-[4px] sm:w-[100%] w-[30%]">
                <Text className="font-bold font-poppins mt-[3px] sm:text-[20px] md:text-[22px] text-[24px] text-white_A700 w-[auto]">
                  Company
                </Text>
                <Column className="flex flex-col justify-start sm:mt-[15px] md:mt-[20px] mt-[39px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[54%]">
                  <Text className="font-normal font-poppins not-italic text-[18px] text-gray_500 w-[auto]">
                    About
                  </Text>
              ...
              <Column className="flex flex-col justify-start sm:mb-[28px] md:mb-[36px] mb-[71px] mt-[4px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[41%]">
                <Text className="font-bold font-poppins sm:text-[20px] md:text-[22px] text-[24px] text-white_A700 w-[auto]">
                  Join our Newsletter
                </Text>
                ...
                <Row className="bg-gray_800 border border-solid border-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-between sm:mt-[13px] md:mt-[18px] mt-[35px] md:pl-[12px] sm:pl-[15px] pl-[24px] w-[100%]">
