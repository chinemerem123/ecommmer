    ...
    <>
      <header className={props.className}>
        <Column className="flex flex-col items-center justify-start w-[100%]">
          <Row className="bg-white_A700 flex flex-row md:flex-wrap sm:flex-wrap items-center justify-end md:p-[12px] sm:p-[15px] p-[24px] w-[100%]">
            <Row className="flex flex-row md:flex-wrap sm:flex-wrap items-start justify-center sm:mb-[3px] md:mb-[4px] mb-[9px] mt-[12px] sm:mt-[4px] md:mt-[6px] sm:mx-[0] sm:px-[0] sm:w-[100%] w-[6%]">
              <Img
